...
Please the postman.json Postman collection file from [here](https://github.com/FRINXio/cli-units/tree/master/postman), into Postman, then open the folder *Mount/Unmount IOS*
