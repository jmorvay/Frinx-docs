...
Save the file.  
2\. Run Karaf: In your `{Frinx ODL main}` directory, type  

    ./bin/karaf  

Once karaf has started (this can take 3 minutes) it will automatically install the odl-mdsal-clustering feature. From that point, single node clustering will be active. You can confirm that the odl-mdsal-clustering 
